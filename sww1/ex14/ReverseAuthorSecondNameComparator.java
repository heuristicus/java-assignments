 ...
 * @author Michal
 */
public class ReverseAuthorSecondNameComparator implements Comparator<Book> {

    /**
     * Checks the title of the book in the opposite way to AuthorComparatorSecondName.  If used in a sort,
